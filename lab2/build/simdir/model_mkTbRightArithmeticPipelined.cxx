...
static void schedule_posedge_CLK(tSimStateHdl simHdl, void *instance_ptr)
	 ...
	 tUInt8 DEF_INST_top_DEF_randomVal_init__h4639;
	 tUInt8 DEF_INST_top_DEF_randomShift_init__h4735;
	 ...
	 INST_top.DEF_bsrap_bsrp_reg4___d5 = INST_top.INST_bsrap_bsrp_reg4.METH_read();
	 INST_top.DEF_bsrap_bsrp_inFifo_notEmpty____d1 = INST_top.INST_bsrap_bsrp_inFifo.METH_notEmpty();
	 INST_top.DEF_bsrap_bsrp_reg4_BIT_71___d6 = INST_top.DEF_bsrap_bsrp_reg4___d5.get_bits_in_word8(2u,
													7u,
													1u);
	 DEF_INST_top_DEF_CAN_FIRE_RL_bsrap_bsrp_shift = (!(INST_top.DEF_bsrap_bsrp_inFifo_notEmpty____d1) || INST_top.INST_bsrap_bsrp_inFifo.METH_i_notEmpty()) && (!(INST_top.DEF_bsrap_bsrp_reg4_BIT_71___d6) || INST_top.INST_bsrap_bsrp_outFifo.METH_i_notFull());
	 DEF_INST_top_DEF_WILL_FIRE_RL_bsrap_bsrp_shift = DEF_INST_top_DEF_CAN_FIRE_RL_bsrap_bsrp_shift;
	 DEF_INST_top_DEF_randomShift_init__h4735 = INST_top.INST_randomShift_init.METH_read();
	 DEF_INST_top_DEF_CAN_FIRE_RL_randomShift_initialize = !DEF_INST_top_DEF_randomShift_init__h4735;
	 DEF_INST_top_DEF_WILL_FIRE_RL_randomShift_initialize = DEF_INST_top_DEF_CAN_FIRE_RL_randomShift_initialize;
	 DEF_INST_top_DEF_randomVal_init__h4639 = INST_top.INST_randomVal_init.METH_read();
	 DEF_INST_top_DEF_CAN_FIRE_RL_randomVal_initialize = !DEF_INST_top_DEF_randomVal_init__h4639;
	 DEF_INST_top_DEF_WILL_FIRE_RL_randomVal_initialize = DEF_INST_top_DEF_CAN_FIRE_RL_randomVal_initialize;
	 INST_top.DEF_x__h5371 = INST_top.INST_input_cycle.METH_read();
	 DEF_INST_top_DEF_CAN_FIRE_RL_test_request = (DEF_INST_top_DEF_randomVal_init__h4639 && (DEF_INST_top_DEF_randomShift_init__h4735 && (INST_top.INST_valFifo.METH_i_notFull() && INST_top.INST_bsrap_bsrp_inFifo.METH_i_notFull()))) && (INST_top.DEF_x__h5371) < 128u;
	 DEF_INST_top_DEF_WILL_FIRE_RL_test_request = DEF_INST_top_DEF_CAN_FIRE_RL_test_request;
	 INST_top.DEF_x__h5722 = INST_top.INST_output_cycle.METH_read();
	 INST_top.DEF_output_cycle_00_EQ_128___d101 = (INST_top.DEF_x__h5722) == 128u;
	 ...
	 if (do_reset_ticks(simHdl))
	 {
	   ...
	   INST_top.INST_bsrap_bsrp_reg0.rst_tick__clk__1((tUInt8)1u);
	   INST_top.INST_bsrap_bsrp_reg1.rst_tick__clk__1((tUInt8)1u);
	   INST_top.INST_bsrap_bsrp_reg2.rst_tick__clk__1((tUInt8)1u);
	   INST_top.INST_bsrap_bsrp_reg3.rst_tick__clk__1((tUInt8)1u);
...
time_t MODEL_mkTbRightArithmeticPipelined::get_creation_time()
{
  ...
  /* Thu Mar 18 23:59:21 UTC 2021 */
  return 1616111961llu;
}
