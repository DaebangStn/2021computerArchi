...
static void schedule_posedge_CLK(tSimStateHdl simHdl, void *instance_ptr)
	 ...
	 tUInt8 DEF_INST_top_DEF_randomVal_init__h4616;
	 tUInt8 DEF_INST_top_DEF_randomShift_init__h4699;
	 ...
	 DEF_INST_top_DEF_randomShift_init__h4699 = INST_top.INST_randomShift_init.METH_read();
	 DEF_INST_top_DEF_CAN_FIRE_RL_randomShift_initialize = !DEF_INST_top_DEF_randomShift_init__h4699;
	 DEF_INST_top_DEF_WILL_FIRE_RL_randomShift_initialize = DEF_INST_top_DEF_CAN_FIRE_RL_randomShift_initialize;
	 DEF_INST_top_DEF_randomVal_init__h4616 = INST_top.INST_randomVal_init.METH_read();
	 DEF_INST_top_DEF_CAN_FIRE_RL_randomVal_initialize = !DEF_INST_top_DEF_randomVal_init__h4616;
	 DEF_INST_top_DEF_WILL_FIRE_RL_randomVal_initialize = DEF_INST_top_DEF_CAN_FIRE_RL_randomVal_initialize;
	 INST_top.DEF_x__h5312 = INST_top.INST_input_cycle.METH_read();
	 DEF_INST_top_DEF_CAN_FIRE_RL_test_request = (DEF_INST_top_DEF_randomVal_init__h4616 && (DEF_INST_top_DEF_randomShift_init__h4699 && (INST_top.INST_valFifo.METH_i_notFull() && INST_top.INST_bsrap_bsrp_inFifo.METH_i_notFull()))) && (INST_top.DEF_x__h5312) < 128u;
	 DEF_INST_top_DEF_WILL_FIRE_RL_test_request = DEF_INST_top_DEF_CAN_FIRE_RL_test_request;
	 INST_top.DEF_x__h5668 = INST_top.INST_output_cycle.METH_read();
	 INST_top.DEF_output_cycle_0_EQ_128___d91 = (INST_top.DEF_x__h5668) == 128u;
...
time_t MODEL_mkTbRightArithmeticPipelined::get_creation_time()
{
  ...
  /* Thu Apr 29 00:13:08 UTC 2021 */
  return 1619655188llu;
}
