...
void MOD_mkCsrFile::METH_wr(tUInt32 ARG_wr_idx, tUInt32 ARG_wr_val)
{
  ...
  DEF_toHostFifo_enqReq_ehrReg___d10 = INST_toHostFifo_enqReq_ehrReg.METH_read();
  DEF_x__h14413 = INST_numBr.METH_read();
  DEF_x__h14395 = INST_numJr.METH_read();
  DEF_x__h14375 = INST_numJ.METH_read();
  ...
  DEF_x__h14446 = INST_numCtr.METH_read();
  DEF_x__h14423 = INST_numMem.METH_read();
  DEF_x_data2__h13878 = INST_numInsts.METH_read();
  DEF_toHostFifo_enqReq_ehrReg_0_BITS_49_TO_0___d25 = (tUInt64)(1125899906842623llu & DEF_toHostFifo_enqReq_ehrReg___d10);
  ...
  if (!(PORT_RST_N == (tUInt8)0u))
  {
    ...
    if (DEF_wr_idx_BIT_12_95_AND_wr_idx_BITS_11_TO_0_96_EQ_ETC___d198)
      dollar_fwrite(sim_hdl, this, "32,s,32", 2147483650u, &__str_literal_4, DEF_x__h14446);
    if (DEF_wr_idx_BIT_12_95_AND_wr_idx_BITS_11_TO_0_96_EQ_ETC___d198)
      dollar_fwrite(sim_hdl, this, "32,s,32", 2147483650u, &__str_literal_5, DEF_x__h14423);
    if (DEF_wr_idx_BIT_12_95_AND_wr_idx_BITS_11_TO_0_96_EQ_ETC___d198)
...
void MOD_mkCsrFile::METH_incInstTypeCnt(tUInt8 ARG_incInstTypeCnt_inst)
{
  ...
  tUInt32 DEF_x__h14442;
  tUInt32 DEF_x__h14350;
  tUInt32 DEF_x__h14385;
  tUInt32 DEF_x__h14403;
  tUInt8 DEF_NOT_incInstTypeCnt_inst_EQ_1_27_29_AND_incInst_ETC___d235;
  tUInt8 DEF_incInstTypeCnt_inst_EQ_1___d227;
  tUInt8 DEF_incInstTypeCnt_inst_EQ_2___d230;
  tUInt8 DEF_incInstTypeCnt_inst_EQ_3___d231;
  tUInt8 DEF_incInstTypeCnt_inst_EQ_4___d232;
  DEF_x__h14413 = INST_numBr.METH_read();
  DEF_x__h14395 = INST_numJr.METH_read();
  DEF_x__h14375 = INST_numJ.METH_read();
  DEF_x__h14446 = INST_numCtr.METH_read();
  DEF_x__h14423 = INST_numMem.METH_read();
  DEF_incInstTypeCnt_inst_EQ_4___d232 = ARG_incInstTypeCnt_inst == (tUInt8)4u;
  DEF_incInstTypeCnt_inst_EQ_3___d231 = ARG_incInstTypeCnt_inst == (tUInt8)3u;
  DEF_incInstTypeCnt_inst_EQ_2___d230 = ARG_incInstTypeCnt_inst == (tUInt8)2u;
  DEF_incInstTypeCnt_inst_EQ_1___d227 = ARG_incInstTypeCnt_inst == (tUInt8)1u;
  DEF_NOT_incInstTypeCnt_inst_EQ_1_27_29_AND_incInst_ETC___d235 = !DEF_incInstTypeCnt_inst_EQ_1___d227 && (DEF_incInstTypeCnt_inst_EQ_2___d230 || (DEF_incInstTypeCnt_inst_EQ_3___d231 || DEF_incInstTypeCnt_inst_EQ_4___d232));
  DEF_x__h14403 = DEF_x__h14413 + 1u;
  DEF_x__h14350 = DEF_x__h14375 + 1u;
  DEF_x__h14385 = DEF_x__h14395 + 1u;
  DEF_x__h14442 = DEF_x__h14446 + 1u;
  DEF_x__h14303 = DEF_x__h14423 + 1u;
  if (DEF_incInstTypeCnt_inst_EQ_1___d227)
    INST_numMem.METH_write(DEF_x__h14303);
  if (DEF_NOT_incInstTypeCnt_inst_EQ_1_27_29_AND_incInst_ETC___d235)
    INST_numCtr.METH_write(DEF_x__h14442);
  if (DEF_incInstTypeCnt_inst_EQ_2___d230)
    INST_numJ.METH_write(DEF_x__h14350);
  if (DEF_incInstTypeCnt_inst_EQ_3___d231)
    INST_numJr.METH_write(DEF_x__h14385);
  if (DEF_incInstTypeCnt_inst_EQ_4___d232)
    INST_numBr.METH_write(DEF_x__h14403);
}
...
void MOD_mkCsrFile::METH_incMissInstTypeCnt(tUInt8 ARG_incMissInstTypeCnt_inst)
{
  ...
  tUInt8 DEF_incMissInstTypeCnt_inst_EQ_0___d241;
  tUInt8 DEF_incMissInstTypeCnt_inst_EQ_1___d243;
  tUInt8 DEF_incMissInstTypeCnt_inst_EQ_2___d245;
  DEF_x__h14543 = INST_numBrMiss.METH_read();
  DEF_x__h14541 = INST_numJrMiss.METH_read();
  DEF_x__h14537 = INST_numJMiss.METH_read();
  DEF_incMissInstTypeCnt_inst_EQ_2___d245 = ARG_incMissInstTypeCnt_inst == (tUInt8)2u;
  DEF_incMissInstTypeCnt_inst_EQ_0___d241 = ARG_incMissInstTypeCnt_inst == (tUInt8)0u;
  DEF_incMissInstTypeCnt_inst_EQ_1___d243 = ARG_incMissInstTypeCnt_inst == (tUInt8)1u;
  DEF_x__h14500 = DEF_x__h14543 + 1u;
  DEF_x__h14493 = DEF_x__h14541 + 1u;
  DEF_x__h14486 = DEF_x__h14537 + 1u;
  if (DEF_incMissInstTypeCnt_inst_EQ_0___d241)
    INST_numJMiss.METH_write(DEF_x__h14486);
  if (DEF_incMissInstTypeCnt_inst_EQ_1___d243)
    INST_numJrMiss.METH_write(DEF_x__h14493);
  if (DEF_incMissInstTypeCnt_inst_EQ_2___d245)
...
unsigned int MOD_mkCsrFile::dump_VCD_defs(unsigned int levels)
{
  ...
  vcd_set_clock(sim_hdl, num, __clk_handle_0);
  vcd_write_def(sim_hdl, num++, "x__h14375", 32u);
  vcd_set_clock(sim_hdl, num, __clk_handle_0);
  vcd_write_def(sim_hdl, num++, "x__h14395", 32u);
  vcd_set_clock(sim_hdl, num, __clk_handle_0);
  vcd_write_def(sim_hdl, num++, "x__h14413", 32u);
  vcd_set_clock(sim_hdl, num, __clk_handle_0);
  vcd_write_def(sim_hdl, num++, "x__h14423", 32u);
  vcd_set_clock(sim_hdl, num, __clk_handle_0);
  vcd_write_def(sim_hdl, num++, "x__h14446", 32u);
  vcd_set_clock(sim_hdl, num, __clk_handle_0);
...
void MOD_mkCsrFile::vcd_defs(tVCDDumpType dt, MOD_mkCsrFile &backing)
{
  ...
  if (dt == VCD_DUMP_XS)
  {
	...
	backing.DEF_x__h14245 = DEF_x__h14245;
      ...
      ++num;
      if ((backing.DEF_x__h14375) != DEF_x__h14375)
      {
	vcd_write_val(sim_hdl, num, DEF_x__h14375, 32u);
	backing.DEF_x__h14375 = DEF_x__h14375;
      }
      ++num;
      if ((backing.DEF_x__h14395) != DEF_x__h14395)
      {
	vcd_write_val(sim_hdl, num, DEF_x__h14395, 32u);
	backing.DEF_x__h14395 = DEF_x__h14395;
      }
      ++num;
      if ((backing.DEF_x__h14413) != DEF_x__h14413)
      {
	vcd_write_val(sim_hdl, num, DEF_x__h14413, 32u);
	backing.DEF_x__h14413 = DEF_x__h14413;
      }
      ++num;
      if ((backing.DEF_x__h14423) != DEF_x__h14423)
      {
	vcd_write_val(sim_hdl, num, DEF_x__h14423, 32u);
	backing.DEF_x__h14423 = DEF_x__h14423;
      }
      ++num;
      if ((backing.DEF_x__h14446) != DEF_x__h14446)
      {
	vcd_write_val(sim_hdl, num, DEF_x__h14446, 32u);
	backing.DEF_x__h14446 = DEF_x__h14446;
      }
      ++num;
